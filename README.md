...
- [轻量 Skill ZIP](https://github.com/zyfjacksonchen-source/ppt-plan-beautify/releases/download/v1.0.0/ppt-plan-beautify-1.0.0.zip)：用于 e-Mate SkillHub，约 350 KiB。
